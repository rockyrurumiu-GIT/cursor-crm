...
def register_rms_models(Base) -> Dict[str, Type]:
    ...
    class RmsCandidate(Base):
        ...
        email_wechat = Column(String, default="")
        age = Column(String, default="")
        work_years = Column(String, default="")
        target_job_id = Column(Integer, ForeignKey("rms_jobs.id"), nullable=True, index=True)
        target_client_id = Column(Integer, ForeignKey("clients.id"), nullable=True, index=True)
    ...
    class RmsJob(Base):
        ...
        salary_cap = Column(String, default="")
        years_required = Column(String, default="")
        education = Column(String, default="")
        overtime_travel = Column(String, default="")
    ...
    class RmsApplication(Base):
        ...
        receive_status = Column(String, default="pending")
        delivery_review_status = Column(String, default="pending")
        hired_at = Column(String, default="")
        converted_to_roster_entry_id = Column(Integer, nullable=True, index=True)
        converted_to_roster_at = Column(String, default="")
        converted_to_roster_by = Column(Integer, ForeignKey("sys_user.id"), nullable=True)
