...
WIDGET_TYPES: FrozenSet[str] = frozenset({
    "number", "bar", "horizontal_bar", "pie", "line", "featured_line", "line_1", "featured_bar", "grouped_1",
...
RMS_BLOCK_LABELS: Dict[str, str] = {
    ...
    "chart_pipeline_dialysis": "图表 · 管道透析",
...
CHART_WIDGET_TYPES: FrozenSet[str] = frozenset({"bar", "horizontal_bar", "pie", "line", "featured_line", "line_1", "featured_bar", "grouped_1"})
CHART_EXTRA_RENDERS: FrozenSet[str] = frozenset({"doughnut", "horizontal_bar"})
DATA_WIDGET_TYPES: FrozenSet[str] = frozenset({"number", "bar", "horizontal_bar", "pie", "line", "featured_line", "line_1", "featured_bar", "grouped_1"})
