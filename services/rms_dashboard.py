...
def _metrics_for_apps(
    ...
    for app in apps:
        ...
        if _status_at(app, histories, snapshot_as_of) == "pending_client_screen":
        ...
        if _status_at(app, histories, snapshot_as_of) == "pending_first_interview":
        ...
        if _status_at(app, histories, snapshot_as_of) == "pending_offer":
